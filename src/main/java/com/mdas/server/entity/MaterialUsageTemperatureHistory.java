...
@Entity
@Table(name = "material_usage_temperature_history")
@Data
public class MaterialUsageTemperatureHistory implements Serializable {
    ...
    @Column(name = "recommended_component", length = 200)
    private String recommendedComponent;

    @Column(name = "recommended_temperature_range", length = 100)
