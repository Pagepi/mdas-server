 ...
 * 材料基础属性历史表
 *
 * @TableName material_basic_properties_history
 */
@Entity
@Table(name = "material_basic_properties_history")
@Data
public class MaterialBasicPropertiesHistory implements Serializable {
    /**
     * 自增主键ID
     */
    @Id
    ...
    public boolean equals(Object that) {
        ...
        MaterialBasicPropertiesHistory other = (MaterialBasicPropertiesHistory) that;
