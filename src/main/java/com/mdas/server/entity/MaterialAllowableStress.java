 ...
 * 材料许用应力表
 *
 * @TableName material_allowable_stress
 */
@Entity
@Table(name = "material_allowable_stress")
@Data
public class MaterialAllowableStress implements Serializable {
    /**
     * 自增主键ID
     */
    @Id
    ...
    public boolean equals(Object that) {
        ...
        MaterialAllowableStress other = (MaterialAllowableStress) that;
