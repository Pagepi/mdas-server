...
@Entity
@Table(name = "material_mechanical_properties_history")
@Data
public class MaterialMechanicalPropertiesHistory implements Serializable {
    ...
    @Column(name = "grain_size_min", precision = 4, scale = 1)
    private BigDecimal grainSizeMin;

    @Column(name = "grain_size_max", precision = 4, scale = 1)
    private BigDecimal grainSizeMax;
